...
| :--- | :--- | :--- | :---: |
| **Local AI** | C++, Python, Kotlin, JNI, llama.cpp, PySide6 | Privacy-first platform running native GGUF inference via JNI[cite: 1]; features CPU/GPU/NPU acceleration[cite: 1] and an offline desktop app[cite: 1]. | [GitHub]([https://github.com](https://github.com/swagatambordoloi/Local-Ai)) |
